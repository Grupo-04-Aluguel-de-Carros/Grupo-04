...
import { createAddressSchema } from '../createAddressSchema.js';

describe('register an address', () => {
  describe('when a valid body', () => {
    it('should validates a body with all fields', () => {
      ...
      const schema = createAddressSchema.safeParse(validInput);
  ...
  describe('when an invalid body', () => {
    it('should return an error for a body without "cep"', () => {
      ...
      const schema = createAddressSchema.safeParse(invalidInput);
      if (!schema.success) {
